...
ERPNEXT_API_KEY = '46186794c49d1a5'
ERPNEXT_API_SECRET = 'c0cb1b11518afb7'
ERPNEXT_URL = 'http://192.168.2.161:8001'
ERPNEXT_VERSION = 14
# HIKVISION_API_URL = "http://127.0.01:9016/artemis/api/attendance/v1/report?format=json"
HIKVISION_API_URL = "http://192.168.0.159:8001/app/file/9d300bd74e"
...
devices = [
    {'device_id':'hikvison1','ip':'192.168.0.75', 'punch_direction': 'AUTO', 'clear_from_device_on_fetch': False},
    # {'device_id':'test_2','ip':'192.168.2.209', 'punch_direction': AUTO, 'clear_from_device_on_fetch': False},
    # {'device_id':'test_3','ip':'192.168.2.209', 'punch_direction': AUTO, 'clear_from_device_on_fetch': False}
]
...
shift_type_device_mapping = [
    {'shift_type_name': ['Regular Shift'], 'related_device_id': ['test_1']}
]
